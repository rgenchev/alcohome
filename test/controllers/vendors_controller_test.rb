...
class VendorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendor" do
    assert_difference('Vendor.count') do
      post vendors_url, params: { vendor: { description: @vendor.description, name: @vendor.name } }
    end
  ...
  test "should update vendor" do
    patch vendor_url(@vendor), params: { vendor: { description: @vendor.description, name: @vendor.name } }
